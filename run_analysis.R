# This is the code to process the data from "Getting and cleaning data peer asse1"
...
# 5. New tidy data set with the average of each variable for each activity and subject.
